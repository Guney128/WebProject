    ...
    <section id="accordion">
      ...
      <div class="collapse" id="faq-17" style="">
        <div class="card card-body border-0 p-0">
          <p>You have to fill in all the sign-up fields, in order to create an account.</p>
      ...
      <div class="collapse" id="faq-18" style="">
        <div class="card card-body border-0 p-0">
          <p>After you sucessfully signed-in, you can login through the "login" site, which you can find in the navbar. </p>
      ...
      <div class="collapse" id="faq-19" style="">
        <div class="card card-body border-0 p-0">
          <p>After you sign in, select “My account” and go to “My profile” to view your account information. To update your address, email address, and preferences, select the “Request Changes” button. You will be sent an email that contains a link to complete your updates.</p>
      ...
      <a class="py-3 d-block h-100 w-100 position-relative z-index-1 pr-1 text-secondary  border-top" aria-controls="faq-20" aria-expanded="false" data-toggle="collapse" href="#faq-20" role="button">
        <div class="position-relative">
          <h2 class="h4 m-0 pr-3">
          Where can I find maps and directions to the hotel?
          </h2>
          <div class="position-absolute top-0 right-0 h-100 d-flex align-items-center">
          <i class="fa fa-plus"></i>
          </div>
      ...
      <div class="collapse" id="faq-21">
        <div class="card card-body border-0 p-0">
          <p>A ticketing system that processes and catalogs customer service requests. Tickets, also known as cases or issues, are properly stored alongside relevant user information.</p>
      ...
      <div class="collapse" id="faq-22">
        <div class="card card-body border-0 p-0">
          <p> 1. Login your account. <br>
          2. Upload your issue and the regarding picture under „create ticket“.  <br>
          3. Wait for the response.  <br>
        </p>
        </div>
      </div>
      ...
      <a class="py-3 d-block h-100 w-100 position-relative z-index-1 pr-1 text-secondary  border-top" aria-controls="faq-16" aria-expanded="false" data-toggle="collapse" href="#faq-16" role="button">
        <div class="position-relative">
          <h2 class="h4 m-0 pr-3">
          How do I contact your hotel if my question isn’t answered here?
          </h2>
          <div class="position-absolute top-0 right-0 h-100 d-flex align-items-center">
          <i class="fa fa-plus"></i>
          </div>
      ...
      <div class="collapse" id="faq-16">
        <div class="card card-body border-0 p-0">
          <p>You can contact us via e-mail or phone for any inquiries. You can find all of our contact information under "Imprint".</p>
